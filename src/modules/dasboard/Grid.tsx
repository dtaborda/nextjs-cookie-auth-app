...
const headRows: HeadRow[] = [
  ...
  { id: 'customerType', numeric: false, disablePadding: false, label: 'Tipo de cliente' },
  { id: 'company', numeric: false, disablePadding: false, label: 'Empresa' },
  { id: 'address', numeric: false, disablePadding: false, label: 'Dirección' },
  { id: 'zone', numeric: false, disablePadding: false, label: 'Localidad' },
];
...
const EnhancedTable = () => {
  ...
  function handleRequestSort(event: React.MouseEvent<unknown>, property: keyof DataType) {
              ...
              {stableSort(rows, getSorting(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell padding="checkbox">
                        <div className={classes.stateColor}>
                          <Checkbox
